...
import { requireAuth, validateCreateBoulder, validateUpdateBoulder } from '#middleware'
...
boulderRouter.post('/', requireAuth, validateCreateBoulder, createBoulderController)
boulderRouter.patch('/:id', requireAuth, validateUpdateBoulder, updateBoulderController)
