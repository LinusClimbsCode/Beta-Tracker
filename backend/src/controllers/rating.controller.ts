...
import { createRating, getRatingById, getBoulderRatings, getUserRatings, updateRating, deleteRating } from '#services/rating.service'
...
export const getBoulderRatingsController = async (req: Request, res: Response) => {
