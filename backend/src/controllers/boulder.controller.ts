...
import { createBoulder, findBoulderById, findAllBoulders, updateBoulder, deleteBoulder } from '#services'
...
export const getAllBouldersController = async (req: Request, res: Response) => {
  ...
  const boulders = await findAllBoulders({ wallId, gymId, setterId, uploadedById, status })
