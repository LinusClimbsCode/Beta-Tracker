...
export const validateCreateRating = (req: Request, res: Response, next: NextFunction) => {
...
export const validateUpdateRating = (req: Request, res: Response, next: NextFunction) => {
