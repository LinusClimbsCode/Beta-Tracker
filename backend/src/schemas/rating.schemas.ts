...
export const createRatingSchema = z
  .object({
    ...
    gradeRating: z.enum(["easy", "appropriate", "hard"], {
      message: "Grade rating must be easy, appropriate, or hard",
    }),
    qualityRating: z.enum(["liked", "neutral", "disliked"], {
      message: "Quality rating must be liked, neutral, or disliked",
    }),
